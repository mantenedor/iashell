...
# Configuração de diretórios - AGORA USA VARIÁVEIS DE AMBIENTE COM FALLBACK PARA $HOME
BASE_DIR = Path(os.environ.get("BASE_DIR", str(Path.home() / "iashell/base")))
KNOWLEDGE_DIR = Path(os.environ.get("KNOWLEDGE_DIR", str(BASE_DIR / "knowledge")))
KNOWLEDGE_RAW_DIR = Path(os.environ.get("KNOWLEDGE_RAW_DIR", str(KNOWLEDGE_DIR / ".raw")))
PARSED_DIR = Path(os.environ.get("PARSED_DIR", str(BASE_DIR / "parsed")))
TMP_DIR = Path(os.environ.get("TMP_DIR", str(BASE_DIR / "tmp")))
TMP_RAW_DIR = Path(os.environ.get("TMP_RAW_DIR", str(TMP_DIR / ".raw")))
DOCS_INDEX_FILE = Path(os.environ.get("DOCS_INDEX_FILE", str(BASE_DIR / "document_catalog.json")))
CHUNKS_FILE = Path(os.environ.get("CHUNKS_FILE", str(BASE_DIR / "chunks.jsonl")))
